                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white"><?= $this->UserModel->getUserWhere(['role_id' => 1])->num_rows(); ?></div>
                        </div>
                        <div class="col-auto">
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['stok != 0'];
                                $totalstok = $this->BookModel->total(
                                    'stok',
                                    $where
                                );
                                echo $totalstok;
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['dipinjam != 0'];
                                $totaldipinjam = $this->BookModel->total(
                                    'dipinjam',
                                    $where
                                );
                                echo $totaldipinjam;
                    ...
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h1 mb-0 font-weight-bold text-white">
                                <?php
                                $where = ['dibooking !=0'];
                                $totaldibooking = $this->BookModel->total('dibooking', $where);
                                echo $totaldibooking;
                                ?>
                            </div>
                        </div>
                    ...
                    <div class="table-responsive table-bordered mt-2">
                        <div class="page-header mx-2">
                            <span class="fas fa-users text-primary mt-2"> Data
                                User</span>
                            <a class="text-danger float-right" href="<?php echo base_url('user/data_user'); ?>"><i class="fas fa-search mt-2 floatright"> Tampilkan</i></a>
                        </div>
                ...
                <div class="card-body">
                    <div class="table-responsive table-bordered mt-2">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mt-3" id="table-datatable">
                                <thead>
                                    <tr>
                                        <th>#</th>
                                        <th>Judul Buku</th>
